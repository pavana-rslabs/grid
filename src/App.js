  ...
  return (
    <div>
      ...
      <div className="cards-wrapper">
        ...
        <div id="category">
          <input className="active" type="button" value="All" />
          <input id="nbtn" type="button" value="Artificial Intelligence" />
          <input id="nbtn" type="button" value="Cloud Computing" />
          <input id="nbtn" type="button" value="DevOps" />
          <input id="nbtn" type="button" value="Programming languages" />
          <input
            id="nbtn"
            type="button"
            value="Mobile Application Developement"
          />
          <input id="nbtn" type="button" value="Technology and Tools" />
          <br />
          <input id="nbtn" type="button" value="Get a Job in a Tech Company" />
          <br />
          <input id="nbtn" type="button" value="Others" />
          <br />
          <br />
        </div>
